 ...
 * 
 * This script takes a CELEX number as input, constructs a URL to access EUR-Lex,
 * scrapes the webpage to find case references, categorizes them, and creates
 * markdown files with the organized data.
 */
